...
/**
 * İlgili sınıfta , ana uygulamanın lifecycle pozisyonu izleniyor.
 * Bu işlemin yapılabilmesi için LifecycleObserver sınıfından extend ettik.
 * lifecycle : Zamanlayıcının gözlemlediği yaşam döngüsü olan bir nesneyi alır.
 */
...
class DessertTimer(lifecycle:Lifecycle) : LifecycleObserver {
    ...
    init {
        lifecycle.addObserver(this) // İçinde bulunduğu activity ' nin lifecycle durumuna bağlanıyor.
    }
